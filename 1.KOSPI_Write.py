...
url = "https://finance.naver.com/sise/dividend_list.nhn?sosok=KOSPI&page="
...
for page in range(1, 14):
    ...
    tr_frst = soup.find("table", attrs={"class":"type_1 tb_ty"}).find("tbody").find("tr", attrs={"class":"tr_frst"}).find_all("td")
    tr_last = soup.find("table", attrs={"class":"type_1 tb_ty"}).find("tbody").find("tr", attrs={"class":"tr_last"}).find_all("td")
